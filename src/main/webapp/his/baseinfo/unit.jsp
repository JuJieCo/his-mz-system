...
<tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
	  ...
	  <form action=" ${pageContext.request.contextPath}/baseinfo/unitAction!editUnit" name="form2" method="post"  id="formID"  >
	  ...
	  &nbsp;名称：<input name="unit.unitName"  type="text" size="30"  value="${unit.unitName }"  id="unitName"  class="validate[required] text-input" />
	  <input name="unit.unitId"  type="hidden"  value="${unit.unitId }" />
	  ...
	  <tr>
        <td width="8" background="${pageContext.request.contextPath}/resource/images/tab_15.gif">&nbsp;</td>
        <td>
        <form action=" ${pageContext.request.contextPath}/baseinfo/unitAction!showUnit" name="form1" method="post" >
		<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6" onmouseover="changeto()"  onmouseout="changeback()">
          <tr>
            <td  height="22" align="center" background="${pageContext.request.contextPath}/resource/images/bg.gif" bgcolor="#FFFFFF" width="25%"><span class="STYLE1">单位名称</span></td>
		 ...
		 <tr>
            <td height="20" bgcolor="#FFFFFF" align="center"><span class="STYLE1">${list.unitName }</span></td>
            <td height="20" bgcolor="#FFFFFF" align="center"><span class="STYLE1">${list.unitStatue eq 0?"无效":"有效" }</span></td>
            <td height="20" bgcolor="#FFFFFF" align="center"><span class="STYLE1">
          <a href="${pageContext.request.contextPath}/baseinfo/unitAction!showUpdateUnit?unitId=${list.unitId}">修改</a>&nbsp;&nbsp;
          <a href="${pageContext.request.contextPath}/baseinfo/unitAction!deleteUnit?unitId=${list.unitId}" onclick="return(confirm('确认要删除吗?'))">删除</a>&nbsp;&nbsp;
          <a href="${pageContext.request.contextPath}/baseinfo/unitAction!updateUnitStatue?unitId=${list.unitId}">${list.unitStatue eq 1?"无效":"有效" }</a>
            </span></td>
