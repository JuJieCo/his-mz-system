      ...
      <tr height="30">
	  	...
	  	<td>
		    <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="b5d6e6">
			 <tr><td class="STYLE3" bgcolor="#FFFFFF">领药单列表</td></tr>
	        </table>
	        <form action="${pageContext.request.contextPath}/inventory/inventoryAction!listOfDotack" name="form1" method="post">
			<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6" onmouseover="changeto()"  onmouseout="changeback()">
	          <tr>        
	            ...
	            <td  height="22" align="center" background="${pageContext.request.contextPath}/resource/images/bg.gif" bgcolor="#FFFFFF" width="auto"><span class="STYLE1">领药单号</span></td>
			  ...
			  <tr>
	            ...
	            <td height="20" bgcolor="#FFFFFF" align="center"><span class="STYLE1">${bill.inventoryBill_statue==3?'已发药':'待处理'}</span></td>
	            <td height="20" bgcolor="#FFFFFF" align="center" class="STYLE3">
	            <c:if test="${bill.inventoryBill_statue!=3}">
	            <a href="${pageContext.request.contextPath}/inventory/inventoryAction!getBillDetail?inventoryBill.inventoryBill_id=${bill.inventoryBill_id}">发药</a>
	            </c:if>
	            <c:if test="${bill.inventoryBill_statue==3}">
	            <span style="color:#666" >已发药</span>
	            </c:if>
	            </td>
	          </tr> 
	          </c:if>
	  ...
	  <tr>
	    ...
	    <td>
	    	...
	    	<table width="100%"  bgcolor="#EFF6FE"  <s:if test="#show!='true'"> style='display:none' </s:if> >
			 <tr><td class="STYLE3" bgcolor="#FFFFFF" height="25">申请领药单明细</td></tr>
			 <tr>
				<td colspan="2">
					...
					<table id="details" width="100%" align="center" border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6">
					  <tr>        
						...
						<td  height="22" align="center" background="${pageContext.request.contextPath}/resource/images/bg.gif" bgcolor="#FFFFFF" width="auto"><span class="STYLE1">公司</span></td>
						...
						<td  height="22" align="center" background="${pageContext.request.contextPath}/resource/images/bg.gif" bgcolor="#FFFFFF" width="auto"><span class="STYLE1">库存</span></td>
					  ...
					  <tr>
						...
						<td height="20" bgcolor="#FFFFFF" align="center"><span class="STYLE1">${one.company.companyName}</span></td>
			...
			<td colspan="2">
				...
				<tr>
					<td align="center" bgcolor="#FFFFFF">
						<input type="submit"  value="发药" class="btn_mouseout" />	
					</td>
				</tr>
				</table>
			</td>
