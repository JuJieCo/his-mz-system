...
function addDetails(){
	...
	str += '<td height="20" bgcolor="#FFFFFF" align="center"><span class="STYLE1"></span></td>'
	str += '<td height="20" bgcolor="#FFFFFF" align="center"><input type="text" name="historyList['+i_num+'].hqty" value="" id="hqty_'+i_num+'" style="width:60px"/></td>'
		...
		function(){
			...
			$.getJSON('${pageContext.request.contextPath}/inventory/inventoryAction!jsonBillDetails',{billID:$(this).attr('[data@b_v]')},function(data){
				...
				$.each(data,function(i,v){
					...
					str+="<td style='font-size:12px'><font color=#ED9020>回退数量 : </font>"+v.hqty+"</td>";
					str+="</tr>";
				});
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr height="30">
		  ...
		  <table width="100%"  bgcolor="#EFF6FE">
		 	 ...
		 	 <tr>
		 		...
		 		<input name="inventoryBill.inventoryBill_type" type="hidden" value="4"/>
		 	 </tr> 
		 	 <tr>
		 	 	<td colspan="2">
	  ...
	  <tr>
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="b5d6e6">
        	<tr><td class="STYLE3" bgcolor="#FFFFFF">回退单列表</td></tr>
        </table>
        <form action="${pageContext.request.contextPath}/inventory/inventoryAction!listOfback" name="form1" method="post">
		<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6" onmouseover="changeto()"  onmouseout="changeback()">
          <tr>        
            ...
            <td  height="22" align="center" background="${pageContext.request.contextPath}/resource/images/bg.gif" bgcolor="#FFFFFF" width="auto"><span class="STYLE1">回退单号</span></td>
		  ...
		  <tr>
            ...
            <td height="20" bgcolor="#FFFFFF" align="center">
            	...
            	${bill.inventoryBill_statue==3?'已回退':''}
            	</span>
            </td>
            <td height="20" bgcolor="#FFFFFF" align="center" class="STYLE3">
            	...
            	<a href="${pageContext.request.contextPath}/inventory/inventoryAction!changeStatueOfBill?inventoryBill.inventoryBill_id=${bill.inventoryBill_id}&inventoryBill.inventoryBill_statue=2&ftype=huitui">提交</a>
				<a href="javascript:if(confirm('确定要删除吗？')){location.href='${pageContext.request.contextPath}/inventory/inventoryAction!delete?inventoryBill.inventoryBill_id=${bill.inventoryBill_id}&ftype=huitui'};">删除</a>
           		</s:if>
            </td>
          </tr> 
