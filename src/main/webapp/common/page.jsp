...
<table width="100%" border="0" cellspacing="0" cellpadding="0" id="ta_page">
  <tr>
    ...
    <td><table border="0" align="right" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td width="100"><div align="center"><span class="STYLE1">每页
          	<input id="odfsz" value="${page.pageSize}" type="hidden"/>
            <input id="fsz" name="" value="${page.pageSize}" type="text" size="4" style="height:12px; width:20px; border:1px solid #999999;" /> 
            条 </span></div></td>
